...
doc = """
B. ĐÁNH GIÁ TÌNH HÌNH KINH TẾ - XÃ HỘI 6 THÁNG ĐẦU NĂM 2021 VÀ NHIỆM VỤ 6 THÁNG CUỐI NĂM 2021
...
def search_and_print_sections(splitter1, splitter2, text):
    found = False
    ...
    for section in sections:
        ...
        section_head = section_lines[0].lower()
        sections_content = "\n".join(section_lines[1:])
        sections_numeric = find_sections(numeric_splitter, sections_content)
        section_info_list.append((section_head, None))
        for section_numeric in sections_numeric:
            section_head_numeric = section_numeric.splitlines()[0].lower()
...
section_info_list, found_roman = search_and_print_sections(roman_splitter, numeric_splitter, doc)
found_numeric = search_and_print_sections(numeric_splitter)
